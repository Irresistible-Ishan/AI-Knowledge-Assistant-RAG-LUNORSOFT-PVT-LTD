...
### Chunking Strategy (Why 512 chunk size & 50 overlap?)
because its good enough for onxx model embedder to handle well without any problems 
and also we have limited API calls so have to minimise retrieval of useless chunks since free api 
